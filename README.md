...
نئوبانک دمو برای مصاحبه Senior Android.

معماری، مدل پول، امنیت لایهٔ اپ، و تست — نه اتصال به بانک واقعی.
داده و API کاملاً نمایشی‌اند.
...
قبض، اسکن کارت و سخت‌سازی production (Pinning، R8، screenshot)
بعد از تکمیل انتقال می‌آیند.
...
> معماری رسمی اندروید با UDF و offline-first.
> Domain جدا است چون قوانین ریال و شبا باید بدون Android تست شوند.
...
├── transactions/
├── profile/
├── bills/              بعد از تکمیل انتقال
└── cards/              بعد از تکمیل انتقال
...
| M6–M8 | قبض، سخت‌سازی production، بستهٔ مصاحبه |
